...
+ (NSString *) getPasswordForUsername: (NSString *) username andServiceName: (NSString *) serviceName error: (NSError **) error {
    ...
    CFTypeRef r = (__bridge CFTypeRef)attributeResult;
    OSStatus status = SecItemCopyMatching((CFDictionaryRef)CFBridgingRetain(attributeQuery), &r);
    ...
    r = (__bridge CFTypeRef)resultData;
    status = SecItemCopyMatching((CFDictionaryRef)CFBridgingRetain(passwordQuery), &r);
